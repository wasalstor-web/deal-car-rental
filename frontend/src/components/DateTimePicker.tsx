...
import { fr, enUS, es, arEG } from 'date-fns/locale'
...
const DateTimePicker = ({
  ...
  return (
    <LocalizationProvider adapterLocale={language === 'fr' ? fr : language === 'es' ? es : language === 'ar' ? arEG : enUS} dateAdapter={AdapterDateFns}>
      <MuiDateTimePicker
        label={label}
        value={value}
        readOnly={readOnly}
