          ...
          <div className="destinations">
            ...
            <div className="tabs">
              <Tabs
                ...
                aria-label={strings.DESTINATIONS_TABS_ARIA}
          ...
          <div className="boxes">
            <div className="box">
              <div className="box-img">
                <img alt={strings.IMG_ALT_MINI} src={Mini} />
              </div>
              ...
              <div className="car-size-action">
                <Button
                  ...
                  aria-label={strings.SEARCH_FOR_CAR_MINI}
            ...
            <div className="box">
              <div className="box-img">
                <img alt={strings.IMG_ALT_MIDI} src={Midi} />
              </div>
              <div className="box-content">
                {/* <FormControlLabel
                  control={(
              ...
              <div className="car-size-action">
                <Button
                  variant="contained"
                  className="btn-primary btn-car-size"
                  aria-label={strings.SEARCH_FOR_CAR_MIDI}
                  disabled={ranges.length === 0}
                  onClick={() => {
            ...
            <div className="box">
              <div className="box-img">
                <img alt={strings.IMG_ALT_MAXI} src={Maxi} />
              </div>
              <div className="box-content">
                {/* <FormControlLabel
                  control={(
              ...
              <div className="car-size-action">
                <Button
                  variant="contained"
                  className="btn-primary btn-car-size"
                  aria-label={strings.SEARCH_FOR_CAR_MAXI}
                  disabled={ranges.length === 0}
                  onClick={() => {
