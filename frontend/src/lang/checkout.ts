...
const strings = new LocalizedStrings({
  fr: {
    ...
    PAY_WITH_MYFATOORAH: 'Payer avec MyFatoorah',
  ...
  es: {
    ...
    PAY_WITH_MYFATOORAH: 'Pagar con MyFatoorah',
  ...
  ar: {
    ...
    EMAIL_INFO: 'سوف تتلقى رسالة تأكيد بالبريد الإلكتروني على هذا العنوان.',
    PHONE_INFO: 'إذا كنا بحاجة إلى الاتصال بك على وجه السرعة.',
    PAYMENT: 'الدفع الآمن',
    ...
    SECURE_PAYMENT_INFO: 'بياناتك محمية عن طريق الدفع الآمن SSL.',
    SUCCESS: 'تمت عملية الدفع الخاصة بك بنجاح. لقد أرسلنا لك رسالة تأكيد بالبريد الإلكتروني.',
    PAY_LATER_SUCCESS: 'لقد تم الحجز الخاص بك بنجاح. لقد أرسلنا لك رسالة تأكيد بالبريد الإلكتروني.',
    PAYMENT_OPTIONS: 'خيارات الدفع',
    PAY_LATER: 'الدفع عند الاستلام',
    PAY_LATER_INFO: 'ادفع المبلغ كاملاً عند استلام السيارة. قد يتم تطبيق وديعة قابلة للاسترداد.',
    PAY_DEPOSIT: 'دفع الوديعة عبر الإنترنت وتأكيد الحجز',
    PAY_DEPOSIT_INFO: 'ادفع الوديعة عبر الإنترنت لتأكيد الحجز. الرصيد المتبقي مستحق عند الاستلام.',
    DEPOSIT: 'إيداع',
    PAY_ONLINE: 'ادفع بدون إيداع واحجز السيارة',
    PAY_ONLINE_INFO: 'أكد حجزك عبر الإنترنت بدون دفع مقدم. دفع المبلغ كاملا عند الاستلام.',
    PAY_IN_FULL: 'ادفع كامل المبلغ عبر الإنترنت واحجز السيارة',
    PAY_IN_FULL_INFO: 'يشمل الإيداع. التعديلات والإلغاء بشروط.',
    PAYMENT_FAILED: 'فشل الدفع.',
    PAY_WITH_MYFATOORAH: 'ادفع عبر ماي فاتورة',
    CHECKING: 'جاري التحقق...',
    LICENSE_REQUIRED: 'مطلوب رخصة القيادة',
    PRICE_FOR: 'سعر ل',
    DAY: 'يوم',
    PICK_UP_CHECKLIST_TITLE: 'قائمة الاختيار الخاصة بك',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: 'الوصول في الوقت المحدد',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT: 'تسمح لك شركات التأجير فقط بالحصول على مفاتيحك في وقت الاستلام المخصص لك، وعادة ما يحتفظون بسيارتك لفترة محدودة بعد موعد استلامها - ومن ثم من المحتمل أن يتم نقلها إلى عميل آخر.',
    PICK_UP_CHECKLIST_DOCUMENTS_TITLE: 'ما الذي تحضره معك',
