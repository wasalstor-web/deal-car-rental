...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    FAQ_DOCUMENTS_TITLE: 'ما هي المستندات التي أحتاجها لاستئجار سيارة؟',
    FAQ_DOCUMENTS_TEXT: 'لاستئجار سيارة، ستحتاج عادةً إلى رخصة قيادة صالحة، وبطاقة ائتمان للدفع ووديعة التأمين، وإثبات التأمين. قد تختلف المتطلبات الإضافية حسب موقعك ونوع السيارة التي تستأجرها.',
    FAQ_SERVICES_TITLE: 'هل تقدمون خدمات التوصيل والاستلام؟',
    FAQ_SERVICES_TEXT: 'نعم، نحن نفعل! نحن نقدم خدمات توصيل واستلام مريحة إلى مواقع مختلفة، بما في ذلك المطارات والفنادق والمزيد. فقط أخبرنا بموقعك المفضل، وسنتولى الباقي.',
    FAQ_AGE_TITLE: 'هل هناك شرط عمري لاستئجار سيارة؟',
    FAQ_AGE_TEXT: 'نعم، الحد الأدنى للعمر المطلوب لاستئجار السيارة هو عادة 18 عامًا. ومع ذلك، قد يكون لدى بعض المواقع متطلبات عمرية أعلى أو قيود إضافية على أنواع معينة من المركبات.',
    FAQ_CANCEL_TITLE: 'ماذا يحدث إذا كنت بحاجة إلى إلغاء حجزي؟',
    FAQ_CANCEL_TEXT: 'نحن ندرك أن الخطط يمكن أن تتغير، ولهذا السبب نقدم سياسات إلغاء مرنة. اعتمادًا على توقيت الإلغاء، قد تكون هناك رسوم مطبقة. يرجى الرجوع إلى الشروط والأحكام الخاصة بنا أو الاتصال بفريق دعم العملاء لدينا للحصول على المساعدة في عمليات الإلغاء.',
