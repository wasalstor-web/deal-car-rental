...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    PRICE: 'سعر',
    STATUS: 'حالة',
    UPDATE_SELECTION: 'تحرير التحديد',
    ...
    EMPTY_LIST: 'لا حجوزات.',
    VIEW: 'عرض هذا الحجز',
    UPDATE: 'تحرير هذا الحجز',
    DAYS: 'أيام',
    COST: 'يكلف',
    CANCEL: 'إلغاء هذا الحجز',
    CANCEL_BOOKING: 'هل أنت متأكد أنك تريد إلغاء هذا الحجز؟',
    CANCEL_BOOKING_REQUEST_SENT: 'لقد تم تقديم طلب الإلغاء الخاص بك. سوف نقوم بالاتصال بك لإنهاء إجراءات الإلغاء.',
