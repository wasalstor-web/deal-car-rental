...
const strings = new LocalizedStrings({
  ...
  ar: {
    TITLE1: `${env.WEBSITE_NAME} - خدمة تأجير السيارات المميزة الخاصة بك`,
    SUBTITLE1: 'شريكك الموثوق به لتأجير السيارات',
    CONTENT1: `في ${env.WEBSITE_NAME}، ندرك أن كل رحلة فريدة من نوعها. نحن ملتزمون بتزويد عملائنا بمجموعة متنوعة من المركبات التي تلبي جميع احتياجات السفر. سواء كنت تستكشف مدينة، أو تتنقل للعمل، أو تبحث عن المغامرة، فإن خدمات تأجير السيارات الموثوقة لدينا تضمن أن تبدأ مغامرتك بسلاسة. مهمتنا هي تقديم خدمة عملاء استثنائية، مما يجعل تجربتك ممتعة وخالية من التوتر. مع الأسعار التنافسية، ومجموعة متنوعة من المركبات التي تتم صيانتها جيدًا، وفريق متخصص جاهز لمساعدتك، فإننا نسعى جاهدين لنكون شريكك الموثوق به على الطريق. اختر ${env.WEBSITE_NAME} لجميع احتياجات تأجير السيارات الخاصة بك واستمتع بحرية الاستكشاف بالسرعة التي تناسبك.`,
    TITLE2: `لماذا تختار ${env.WEBSITE_NAME}`,
    SUBTITLE2: 'استمتع بتجربة التميز في كل رحلة',
    CONTENT2: 'استمتع براحة وموثوقية وقيمة لا مثيل لها مع خدمة تأجير السيارات المتميزة لدينا. بدءًا من الحجوزات السهلة وحتى المركبات عالية الجودة، نحن شريك السفر الموثوق به.',
    FIND_DEAL: 'ابحث عن الصفقة',
