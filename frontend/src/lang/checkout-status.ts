...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    SUCCESS: 'تمت عملية الدفع الخاصة بك بنجاح. لقد أرسلنا لك رسالة تأكيد بالبريد الإلكتروني.',
    SUCCESS_PAY_LATER: 'لقد تم الحجز الخاص بك بنجاح. لقد أرسلنا لك رسالة تأكيد بالبريد الإلكتروني.',
    ERROR: 'حدث خطأ ما! حاول مرة أخرى لاحقًا',
    STATUS_TITLE: `${env.WEBSITE_NAME} تأكيد الحجز`,
    STATUS_MESSAGE: 'تحقق من صندوق البريد الخاص بك واتبع الخطوات الموضحة في رسالة تأكيد الحجز الإلكترونية لحجز سيارتك.',
