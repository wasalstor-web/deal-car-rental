...
const strings = new LocalizedStrings({
  fr: {
    ...
    CO2: 'Effet CO2',
    FROM_YOU: ' de vous',
    DISTANCE_ICON_ALT: 'Indicateur de distance depuis le lieu de prise en charge',
    RATING_ICON_ALT: 'Note clients',
    CO2_ICON_ALT: 'Indicateur d’émissions CO₂',
    TITLE_1: 'Auto ',
    TITLE_2: ' pour vous',
  ...
  en: {
    ...
    CO2: 'CO2 effect',
    FROM_YOU: ' from you',
    DISTANCE_ICON_ALT: 'Distance from pick-up location',
    RATING_ICON_ALT: 'Customer rating',
    CO2_ICON_ALT: 'CO₂ emissions indicator',
    TITLE_1: 'Auto ',
    TITLE_2: ' for you',
  ...
  es: {
    ...
    CO2: 'Efecto CO2',
    FROM_YOU: ' de ti',
    DISTANCE_ICON_ALT: 'Distancia desde el punto de recogida',
    RATING_ICON_ALT: 'Valoración de clientes',
    CO2_ICON_ALT: 'Indicador de emisiones de CO₂',
    TITLE_1: 'Auto ',
    TITLE_2: ' para ti',
  ...
  ar: {
    ...
    ELECTRIC: 'كهربائي',
    HYBRID: 'هجين',
    PLUG_IN_HYBRID: 'المكونات في الهجين',
    UNKNOWN: 'غير محدد',
    DIESEL_SHORT: 'د',
    GASOLINE_SHORT: 'ز',
    ELECTRIC_SHORT: 'ه',
    HYBRID_SHORT: 'ح',
    PLUG_IN_HYBRID_SHORT: 'الرقم الهيدروجيني',
    GEARBOX_MANUAL: 'يدوي',
    GEARBOX_AUTOMATIC: 'تلقائي',
    GEARBOX_MANUAL_SHORT: 'م',
    GEARBOX_AUTOMATIC_SHORT: 'أ',
    FUEL_POLICY_LIKE_FOR_LIKE: 'مثل لمثل',
    FUEL_POLICY_FREE_TANK: 'خزان مجاني',
    FUEL_POLICY_FULL_TO_FULL: 'كامل إلى كامل',
    FUEL_POLICY_FULL_TO_EMPTY: 'ممتلئ إلى فارغ',
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: 'يتم تزويد هذه السيارة بالوقود ويجب إعادتها بنفس كمية الوقود.',
    FUEL_POLICY_FREE_TANK_TOOLTIP: 'السعر يشمل خزان وقود كامل.',
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'هذه السيارة مزودة بخزان وقود ممتلئ ويجب إعادتها بخزان وقود ممتلئ.',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'يتم تزويد هذه السيارة بخزان وقود ممتلئ ويجب إعادتها بخزان فارغ.',
    DIESEL_TOOLTIP: 'هذه السيارة لديها محرك ديزل',
    GASOLINE_TOOLTIP: 'هذه السيارة لديها محرك البنزين',
    ELECTRIC_TOOLTIP: 'هذه السيارة كهربائية',
    HYBRID_TOOLTIP: 'هذه السيارة هجينة',
    PLUG_IN_HYBRID_TOOLTIP: 'هذه السيارة هجينة',
    GEARBOX_MANUAL_TOOLTIP: 'تحتوي هذه السيارة على علبة تروس يدوية',
    GEARBOX_AUTOMATIC_TOOLTIP: 'تحتوي هذه السيارة على علبة تروس أوتوماتيكية',
    SEATS_TOOLTIP_1: 'هذه السيارة لديها',
    SEATS_TOOLTIP_2: 'مقاعد',
    DOORS_TOOLTIP_1: 'هذه السيارة لديها',
    DOORS_TOOLTIP_2: 'أبواب',
    AIRCON_TOOLTIP: 'هذه السيارة بها مكيف هواء',
    ...
    THEFT_PROTECTION_TOOLTIP: 'قد يشمل الإيجار الحماية من السرقة.',
    COLLISION_DAMAGE_WAVER: 'التنازل عن أضرار الاصطدام',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'قد يشمل الإيجار التنازل عن أضرار الاصطدام.',
    FULL_INSURANCE: 'التأمين الكامل',
    FULL_INSURANCE_TOOLTIP: 'قد يشمل الإيجار التنازل عن أضرار الاصطدام وحماية السيارة من السرقة.',
    ADDITIONAL_DRIVER: 'سائق إضافي',
    INCLUDED: 'متضمنة',
    UNAVAILABLE: 'غير متاح',
    CAR_AVAILABLE: 'متاحة للتأجير',
    CAR_AVAILABLE_TOOLTIP: 'هذه السيارة متاحة للتأجير.',
    CAR_UNAVAILABLE: 'غير متاح للتأجير',
    CAR_UNAVAILABLE_TOOLTIP: 'هذه السيارة غير متاحة للتأجير.',
    VIEW_CAR: 'شاهد هذه السيارة',
    EMPTY_LIST: 'لا سيارات.',
    BOOK: 'اختر هذه السيارة',
    PRICE_DAYS_PART_1: 'سعر ل',
    PRICE_DAYS_PART_2: 'يوم',
    PRICE_PER_DAY: 'السعر في اليوم الواحد:',
    GEARBOX: 'علبة التروس',
    ENGINE: 'محرك',
    DEPOSIT: 'إيداع عند الاستلام',
    ...
    FROM_YOU: 'منك',
    DISTANCE_ICON_ALT: 'المسافة من موقع الاستلام',
    RATING_ICON_ALT: 'تقييم العملاء',
    CO2_ICON_ALT: 'مؤشر انبعاثات ثاني أكسيد الكربون',
    TITLE_1: 'آلي',
    TITLE_2: 'لك',
    TITLE_CAR_AVAILABLE: 'السيارة متاحة',
    TITLE_CARS_AVAILABLE: 'السيارات المتاحة',
    DETAILS: 'تفاصيل',
    FULLY_BOOKED: 'محجوزة بالكامل',
    COMING_SOON: 'قريباً',
    CAR_RANGE_MINI: 'سيارة',
    CAR_RANGE_MIDI: 'سيارات الدفع الرباعي',
    CAR_RANGE_MAXI: 'فان',
    CAR_RANGE_SCOOTER: 'سكوتر',
    CAR_RANGE_BUS: 'حافلة',
    CAR_RANGE_TRUCK: 'شاحنة',
    CAR_RANGE_CARAVAN: 'قافلة',
