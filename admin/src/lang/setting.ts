...
const strings = new LocalizedStrings({
  ...
  ar: {
    SETTINGS: 'إعدادات الإيجار',
    MIN_PICKUP_HOURS: 'الحد الأدنى من الوقت المطلوب بالساعات قبل الاستلام',
    MIN_RENTAL_HOURS: 'الحد الأدنى لمدة الإيجار بالساعات بين الاستلام والتوصيل',
    MIN_PICKUP_DROPOFF_HOUR: 'الحد الأدنى المسموح به للساعة للالتقاء والتوصيل (على سبيل المثال، 9 للساعة 09:00)',
    MAX_PICKUP_DROPOFF_HOUR: 'الحد الأقصى للساعة المسموح بها للالتقاء والتوصيل (على سبيل المثال، 19 مقابل 19:00)',
