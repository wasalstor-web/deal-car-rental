...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    UNCHECK_ALL: 'قم بإلغاء تحديد الكل',
    CHECK_ALL: 'تحقق من كل شيء',
    CLOSE: 'يغلق',
    BOOKING_STATUS_VOID: 'فارغ',
    BOOKING_STATUS_PENDING: 'قيد الانتظار',
    BOOKING_STATUS_DEPOSIT: 'إيداع',
    BOOKING_STATUS_PAID: 'مدفوع',
    BOOKING_STATUS_PAID_IN_FULL: 'مدفوعة بالكامل',
    BOOKING_STATUS_RESERVED: 'محجوز',
    BOOKING_STATUS_CANCELLED: 'تم الإلغاء',
    FROM: 'من',
    TO: 'ل',
    OPTIONAL: 'المعلمات الاختيارية',
    AND: 'و',
    RECORD_TYPE_ADMIN: 'مسؤل',
    ...
    BIRTH_DATE_NOT_VALID_PART1: 'يجب أن يكون السائق على الأقل',
    BIRTH_DATE_NOT_VALID_PART2: 'سنة.',
    PAY_LATER: 'تفويض الدفع في وقت لاحق',
    ANY: 'أي',
    NAME: 'اسم',
    LONGITUDE: 'خط الطول',
    LATITUDE: 'خط العرض',
    ...
    PRICE_CHANGE_RATE: 'معدل تغير السعر (+/- %)',
    SUPPLIER_CAR_LIMIT: 'الحد الأقصى المسموح به للسيارات في البحث',
    NOTIFY_ADMIN_ON_NEW_CAR: 'إخطار المشرف على السيارة الجديدة',
    BLACKLISTED: 'القائمة السوداء',
    BLACKLISTED_TOOLTIP: 'لم يعد بإمكان المستخدمين المدرجين في القائمة السوداء الوصول إلى النظام الأساسي.',
    FIELD_NOT_VALID: 'يرجى احترام الشكل المطلوب',
