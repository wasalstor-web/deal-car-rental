...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    CAR_CURRENCY: `${commonStrings.CURRENCY}/يوم`,
    ...
    CAR_AVAILABLE_TOOLTIP: 'تم إدراج هذه السيارة في نتائج البحث.',
    CAR_UNAVAILABLE: 'غير مدرجة في نتائج البحث',
    CAR_UNAVAILABLE_TOOLTIP: 'لم يتم إدراج هذه السيارة في نتائج البحث.',
    VIEW_CAR: 'شاهد هذه السيارة',
    EMPTY_LIST: 'لا سيارات.',
    CANNOT_DELETE_CAR: 'لا يمكن حذف هذه السيارة لأنها مرتبطة بالحجوزات. ومع ذلك، يمكنك جعله غير متاح للتأجير عن طريق تعديله.',
    GEARBOX: 'علبة التروس',
    ENGINE: 'محرك',
